...
fdescribe('getFileHash', () => {
  ...
  it('Hash should match have same length', async () => {
    ...
    service
      .getFileHash('file.txt', FilesystemDirectory.Documents)
      .subscribe(x => {
...
fdescribe('getJsonData', () => {
  ...
  it('Json Data should match', async () => {
    ...
    service
      .getJsonData('file.txt', true, FilesystemDirectory.Documents)
      .subscribe(x => {
...
fdescribe('saveJsonData', () => {
  ...
  it('Json Data should save', done => {
    ...
    service
      .saveJsonData(data, FilesystemDirectory.Documents)
      .subscribe(async x => {
